...
<footer className="self-stretch bg-background-secondary flex flex-row py-10 px-[195px] sm:pl-[10px] items-center justify-start gap-[30px] text-left text-3xl text-text font-base-body-space-mono">
        <div className="self-stretch flex flex-row items-start justify-between">
          <div className="w-[327.41px] sm:ml-[30%] sm:w-[100%] flex flex-col py-0 pr-[84px] pl-0 box-border items-start justify-start gap-[30px] text-base text-lightgray font-h3-work-sans">
          ...
          <div className="w-60 flex flex-col sm:hidden items-start justify-start gap-[25px]">
          ...
          <div className="w-1/2 sm:hidden flex flex-col items-start justify-start gap-[25px]">
